...
import { Building2, LayoutDashboard, TrendingUp, FileBarChart, LogOut, Menu, X } from 'lucide-react';
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-50 bg-white border-b border-gray-200 shadow-sm">
        <div className="flex items-center justify-between p-4">
          ...
          <div className="w-9 h-9 bg-blue-100 rounded-full flex items-center justify-center">
            <span className="text-blue-600 font-bold text-[10px]">CEO</span>
          </div>
        </div>
      </div>
          ...
          <div className="hidden lg:block p-6 border-b border-gray-200">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-blue-600 font-medium">CEO Dashboard</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-4 border-t border-gray-200">
            <div className="flex items-center space-x-3 px-4 py-2 mb-2">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-gray-900 truncate">ผู้บริหาร</p>
                <p className="text-xs text-gray-500 truncate">ceo@company.com</p>
              </div>
            </div>
            <Link
              href="/login"
