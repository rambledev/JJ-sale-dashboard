...
import { Building2, LayoutDashboard, Users, FileText, BarChart3, LogOut, Menu, X } from 'lucide-react';
import Link from 'next/link';
import { usePathname } from 'next/navigation';
import { useState } from 'react';

const menuItems = [
  { icon: LayoutDashboard, label: 'Dashboard', href: '/head' },
  { icon: Users, label: 'จัดการทีม', href: '/head/team' },
  { icon: FileText, label: 'ประวัติการขาย', href: '/head/history' },
  { icon: BarChart3, label: 'รายงาน', href: '/head/reports' },
];
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-50 bg-white border-b border-gray-200 shadow-sm">
        <div className="flex items-center justify-between p-4">
          <button
            ...
            className="p-2 bg-green-600 text-white rounded-lg shadow-md hover:bg-green-700 transition"
          >
          ...
          <div className="hidden lg:block p-6 border-b border-gray-200">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-green-600 font-medium">หัวหน้าหน่วยขาย</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-4 border-t border-gray-200">
            <div className="flex items-center space-x-3 px-4 py-2 mb-2">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-gray-900 truncate">หัวหน้าหน่วย กรุงเทพ</p>
                <p className="text-xs text-gray-500 truncate">head@company.com</p>
              </div>
            </div>
            <Link
              href="/login"
